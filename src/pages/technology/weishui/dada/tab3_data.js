const data = [
    ...
    },
    {
        ...
        title: '出水水质参数',
        modalData: [
            { title: '出水PH值：', unit: 'PH', no: 'AB.PLC5.AIT526_PH_OUT_AI', formatter: (v)=> parseFloat(v).toFixed(2)},
            ...
            { title: '出水氨氮：', unit: 'mg/l', no: 'AB.PLC5.AIT528_OUT_AI', formatter: (v)=> parseFloat(v).toFixed(2)},
            { title: '出水总磷：', unit: 'mg/l', no: 'AB.PLC5.AIT530_OUT_AI', formatter: (v)=> parseFloat(v).toFixed(2)},
    ...
    
    {
        ...
        allStatus: ['FXHLC.FXH.P001A_Trip_Fault', 'FXHLC.FXH.P001A_Run'],
        status1: 'FXHLC.FXH.P001A_Trip_Fault',//故障
        status2: 'FXHLC.FXH.P001A_Run',//运行
        propertise: [
            { no: 'FXHLC.FXH.P001A_Remote', dataType: 'Boolean', name: '远程'},
            { no: 'FXHLC.FXH.P001A_Run', dataType: 'Boolean', name: '运行'},
    ...
    },
    {
        ...
        allStatus: ['FXHLC.FXH.P001B_Trip_Fault', 'FXHLC.FXH.P001B_Run'],
        status1: 'FXHLC.FXH.P001B_Trip_Fault',//故障
        status2: 'FXHLC.FXH.P001B_Run',//运行
        propertise: [
            { no: 'FXHLC.FXH.P001B_Remote', dataType: 'Boolean', name: '远程'},
            { no: 'FXHLC.FXH.P001B_Run', dataType: 'Boolean', name: '运行'},
    ...
    },
    {
        ...
        allStatus: ['FXHLC.FXH.P001C_Fault', 'FXHLC.FXH.P001C_Run'],
        status1: 'FXHLC.FXH.P001C_Fault',//故障
        status2: 'FXHLC.FXH.P001C_Run',//运行
        propertise: [
            { no: 'FXHLC.FXH.P001C_Remote', dataType: 'Boolean', name: '远程'},
            { no: 'FXHLC.FXH.P001C_Run', dataType: 'Boolean', name: '运行'},
