    ...
    render(){
        ...
        const tableColumns = [
            ...
            },
            {
                ...
                align: 'center',
                render:(text,record) => <>
                    <Button type="link" size="small"onClick={this.openDetail.bind(this,record.id)} authcode="inventory:outWarehouse:info" icon="info">详情</Button>
                    <Button type="link" size="small" onClick={this.openEdit.bind(this,record.id)} authcode="inventory:outWarehouse:update" icon="edit">修改</Button>
                    <Button type="link" size="small" danger onClick={this.delete.bind(this,record.id)} authcode="inventory:outWarehouse:delete" icon="delete">删除</Button>
                </>,
            },
        ];
        ...
        return(
            <>
                ...
                >
                    ...
                    <Form.Item>
                        <Button type="primary" onClick={this.openEdit.bind(this,"")} authcode="inventory:outWarehouse:save" icon="add">新增</Button>
                    </Form.Item>
                </Form>
                <Table
                    rowKey="id"
                    ...
                    method="get"
                    url="api/wms/twarehousebill/list?type=1"
                />
